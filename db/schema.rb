...
ActiveRecord::Schema.define(version: 2020_01_25_010357) do
  ...
  create_table "admin_users_pages", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
